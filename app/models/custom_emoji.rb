...
class CustomEmoji < ApplicationRecord
  ...
  has_attached_file :image, styles: { static: { format: 'webp', convert_options: '-coalesce -delete 1--1 +profile "!icc,*" +set date:modify +set date:create +set date:timestamp', file_geometry_parser: FastGeometryParser } }, validate_media_type: false, processors: [:lazy_thumbnail]
